		...
		<div class="navbar navbar-default navbar-static-top" id="navBarMainStyle">
                ...
                <div class="collapse navbar-collapse" id="navbar-ex-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="dropdown" id="navBarDropdown">
                            ...
                            <a href="index.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Create Event<i class="fa fa-caret-down"></i></a>
			...
			<div class="container" style="border: 10px #55837D solid; border-radius: 10px; height: 100%; padding: 20px;">
				...
				<form action="scriptCreateEvent.php" method="POST" enctype="multipart/form_data">
					...
					<label for="authority" style="width: 20%; text-align: center; font-family: 'Oswald', cursive; padding: 10px; color: white;">Authority</label>
					<input type="text" name="authority" style="border-collapse: collapse; width: 70%" />
					<br />
					
					<label for="locality" style="width: 20%; text-align: center; font-family: 'Oswald', cursive; padding: 10px; color: white;">Locatlity</label>
					<input type="text" name="locality" style="border-collapse: collapse; width: 70%" />
					<br />
				
					<label for="eventTitle" style="width: 20%; text-align: center; font-family: 'Oswald', cursive; padding: 10px; color: white;">Event Title</label>
					<input type="text" name="eventTitle" style="border-collapse: collapse; width: 70%" />
					<br />

					<label for="eventWhere" style="width: 20%; text-align: center; font-family: 'Oswald', cursive; padding: 10px; color: white;">Location of event</label>
					<input type="text" name="eventWhere" style="border-collapse: collapse; width: 70%" />
					<br />
				
					<label for="eventStart" style="width: 20%; text-align: center; font-family: 'Oswald', cursive; padding: 10px; color: white;">Event Start</label>
        			...
        			<label for="eventEnd" style="width: 20%; text-align: center; font-family: 'Oswald', cursive; padding: 10px; color: white;">Event End</label>
					...
					<label for="eventText" style="width: 100%; text-align: left; font-family: 'Oswald', cursive; padding: 10px; color: white;">What is the cause for your event?</label>
					<br />
