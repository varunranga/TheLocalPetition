		...
		<script type="text/javascript">
			...
			function makeNotifications()
			{
				...
				for (i = 0; i < notifications.length; i++)
				{
					...
					var notifBox = "<div class='container-fluid notification"+notifications[i][3]+"'><br /><a href='viewProfile?viewID="+notifications[i][1]+"'><img src='"+notifications[i][4]+"' class='viewImage' />"+notifications[i][2]+"Click <a href='postView.php?postID="+notifications[i][0]+"'>here to see post.</a><br /><br /></div></a><hr />";
