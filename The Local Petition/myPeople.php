        		...
        		<div class="row" id="followers">
          			...
          			<div class="col-md-12">
          				...
          				<div id="othersDiv">
          					...
          					<h1 class="text-center" style="text-shadow: 2px 2px #ff0000">People in your locality</h1>
    	...
    	<script type="text/javascript">
    		...
    		function setFollowers()
    		{
    			...
    			for (i = 0; i < followers.length; i++)
    			{
    				...
    				var followerBox = "<div class='col-md-2'><a href='viewProfile.php?viewID="+followers[i][3]+"'><img src='"+followers[i][2]+"' id='picture'></a><h2><a href='viewProfile.php?viewID="+followers[i][3]+"'>"+followers[i][0]+" "+followers[i][1]+"</a></h2></div>"
    		...
    		function setFollowings()
    		{
    			...
    			for (i = 0; i < followings.length; i++)
    			{
    				...
    				var followingBox = "<div class='col-md-2'><a href='viewProfile.php?viewID="+followings[i][3]+"'><img src='"+followings[i][2]+"' id='picture'></a><h2><a href='viewProfile.php?viewID="+followings[i][3]+"'>"+followings[i][0]+" "+followings[i][1]+"</a></h2></div>"
    		...
    		function setOthers()
    		{
    			...
    			for (i = 0; i < others.length; i++)
    			{
    				...
    				var otherBox = "<div class='col-md-2'><a href='viewProfile.php?viewID="+others[i][3]+"'><img src='"+others[i][2]+"' id='picture'></a><h2><a href='viewProfile.php?viewID="+others[i][3]+"'>"+others[i][0]+" "+others[i][1]+"</a></h2></div>"
