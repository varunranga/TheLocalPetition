                ...
                <div class="collapse navbar-collapse" id="navbar-ex-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="dropdown" id="navBarDropdown">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Notifications<i class="fa fa-caret-down"></i></a>
		...
		<script type="text/javascript">
			...
			function makeNotifications()
			{
				...
				for (i = 0; i < notifications.length; i++)
				{
					...
					var notifBox = "<a href='postView.php?postID="+notifications[i][0]+"'><div class='container-fluid notification"+notifications[i][3]+"'><br /><a href='viewProfile?viewID="+notifications[i][1]+"'><img src='"+notifications[i][4]+"' class='viewImage' /></a>"+notifications[i][2]+"<br /><br /></div></a><hr />";
